...
# =========================================================
# VALORES OMR DEFINIDOS POR MANUEL (porcentaje de recorte)
# =========================================================
VALORES_OMR = {
    "x0": 0.11,
    "y0": 0.23,
...
# =========================================================
# FUNCION: Leer QR robusto antes de procesar
# =========================================================
...
# =========================================================
# FUNCION: Normalizar imagen (contraste + binarización)
# =========================================================
...
# =========================================================
# FUNCION: Corregir inclinación de la imagen
# =========================================================
def corregir_inclinacion(th):
    coords = np.column_stack(np.where(th > 0))
    if len(coords) == 0:
        return th  # Imagen vacía, no rotamos
...
# =========================================================
# FUNCION: Recortar imagen según porcentaje definido
# =========================================================
...
# =========================================================
# FUNCION: Detectar respuestas OMR 20 preguntas
# =========================================================
...
# =========================================================
# FUNCION PRINCIPAL: Procesar imagen OMR completa
# =========================================================
